    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
          <h6 class="text-white text-capitalize ps-3">جدول المستخدمين</h6>
        </div>
      </div>
          ...
          <table class="table align-items-center justify-content-center mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span class="text-xs text-center font-weight-bold">{{$data->name}}</span>
                </td>
                <td>
                  <span class="text-xs text-center font-weight-bold">{{$data->email}}</span>
                </td>
                <td>
                  @if($data->usertype == '0')
                ...
                <td>
                  @if($data->usertype == '0')
                    <a href="{{url('/delete_user',$data->id)}}" class="btn btn-danger">Delete</a>
