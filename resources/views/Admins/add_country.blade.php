...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="card" style="width: 80%;margin-left:10%;">
        ...
        <div class="card-body" >
            <form action="{{url('add_country_data')}}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="row">
                    <div style="text-align:right;" class="col-md-12 mb-3">
                        <label>Country Name</label>
                        <input type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="country_name" required />
                    </div>
                    
                    <div style="text-align:right;" class="col-md-12 mb-3">
                      <input value="Add Country" style="background-color: crimson" type="submit" class="btn btn-primary"  />
                    </div>
