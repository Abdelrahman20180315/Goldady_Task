...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="card" style="width: 80%;margin-left:10%;">
        ...
        <div class="card-body" >
            <form action="{{url('add_volt_data')}}" method="POST" enctype="multipart/form-data">
              @csrf
               <div class="row">
                    <div style="text-align:right;" class="col-md-12 mb-3">
                    <label>Volt Name</label>
                        <input  type="text" style="background-color:OldLace;text-align:right" class="form-control"  name="volt_name"  required/>
                    </div>  
                    <div class="col-md-12 mb-3">
                      <label>Choose Type</label>
                      <select class="form-select" name="volt_type" aria-label="Default select example" required>                        
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <select class="form-select" name="volt_country" aria-label="Default select example" required>                        
