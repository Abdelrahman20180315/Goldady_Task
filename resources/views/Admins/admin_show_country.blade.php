...
<div  class="row">
  <div  class="col-12">
      <div style="text-align:right" class="col-md-12 mb-3">
        <form action="{{url('search_country')}}" method="GET">
    ...
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
          ...
          <h6 class="text-white text-capitalize ps-3">Show Countries</h6>
        </div>
      </div>
          ...
          <table class="table align-items-center justify-content-center mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span class="text-xs font-weight-bold">{{$data->country_name}}</span>
                </td>
                <td class="align-middle">
                  <a href="{{url('delete_country',$data->id)}}" class="btn btn-danger">
                    Delete
                  </a>
                </td>
